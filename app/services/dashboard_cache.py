        ...
        try:
            query = """
                ...
                ON DUPLICATE KEY UPDATE
                    ...
                    leads_no_record = new.leads_no_record,
                    wish_to_record = new.wish_to_record,
                    conversion_rate = new.conversion_rate,
                    avg_score_all = new.avg_score_all,
                    avg_score_leads = new.avg_score_leads,
                    avg_score_cancel = new.avg_score_cancel,
                    cancel_calls = new.cancel_calls,
                    reschedule_calls = new.reschedule_calls,
                    cancel_share = new.cancel_share,
                    avg_talk_all = new.avg_talk_all,
                    total_talk_time = new.total_talk_time,
                    avg_talk_record = new.avg_talk_record,
                    avg_talk_navigation = new.avg_talk_navigation,
                    avg_talk_spam = new.avg_talk_spam,
                    complaint_calls = new.complaint_calls,
                    avg_score_complaint = new.avg_score_complaint,
                    cached_at = NOW()
            """
